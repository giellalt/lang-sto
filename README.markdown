...
This directory contains source files for the Stoney language morphology
...
-   <https://giellalt.uit.no/lang/sto/NakodaDocumentation.html>
    (analyser)
...
In order to compile and use Stoney language morphology and dictionaries,
you need:
...
The Stoney language sources can be acquired using [giella SVN
